---
title: "Multinomial Regression Using `pg_lm()`"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Multinomial Regression Using `pg_lm()`}
...
<img src="plot-dag-1.png" title="Directed acyclic graph (DAG) representation of the multinomial regression model" alt="Directed acyclic graph (DAG) representation of the multinomial regression model" style="display: block; margin: auto;" />
...
<img src="plot-dag-pg-1.png" title="Directed acyclic graph (DAG) representation of the Polya-gamma multinoimial regression model" alt="Directed acyclic graph (DAG) representation of the Polya-gamma multinoimial regression model" style="display: block; margin: auto;" />
...
<img src="plot-data-1.png" title="plot of chunk plot-data" alt="plot of chunk plot-data" style="display: block; margin: auto;" />
...
<img src="plot-trace-1.png" title="plot of chunk plot-trace" alt="plot of chunk plot-trace" style="display: block; margin: auto;" />
...
<img src="plot-beta-1.png" title="plot of chunk plot-beta" alt="plot of chunk plot-beta" style="display: block; margin: auto;" />
...
<img src="trace-plot-sampled-data-1.png" title="plot of chunk trace-plot-sampled-data" alt="plot of chunk trace-plot-sampled-data" style="display: block; margin: auto;" />
...
<img src="plot-beta-sampled-data-1.png" title="plot of chunk plot-beta-sampled-data" alt="plot of chunk plot-beta-sampled-data" style="display: block; margin: auto;" />
